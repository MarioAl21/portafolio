...
<a href="?pagina=consultarUsuarios" class="btn btn-primary" style="margin-left:50rem">Consultar usuarios</a>

<!-- Formulario de inicio (header) //-->
<form method="post" class="form-reg" id="signup-form">
    <h2 class="form-title">Crear a un nuevo administrador o conductor</h2>
    ...
    <div class="form-group">
     ...
     <svg xmlns="http://www.w3.org/2000/svg" viewBox="-2 -5 24 24" width="24" fill="currentColor"><path d="M2 0h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2zm0 2v10h16V2H2zm9 2h5a1 1 0 0 1 0 2h-5a1 1 0 0 1 0-2zm0 3h5a1 1 0 0 1 0 2h-5a1 1 0 0 1 0-2zM4 4h3a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1z"></path></svg>
       ...
       <input type="text" class="formulario__input controls" name="nombre" id="nombre">
	     <i class="formulario__validacion-estado fas fa-times-circle"></i>
      </div>
      <p class="formulario__input-error">¡Recuerda! el nombre es obligatorio.</p>
    </div>
	...
	<i class="formulario__validacion-estado fas fa-times-circle"></i>
      ...
      <p class="formulario__input-error">¡Recuerda! Los apellidos son obligatorios.</p>
    </div>    
    ...
    <div class="formulario__grupo" id="grupo__terminos">
     ...
     <input class="formulario__checkbox" type="checkbox" name="tipo" value="administrador">
	    Adminstrador <br />
      <input class="formulario__checkbox" type="checkbox"  name="tipo" value="conductor">
	    Conductor
     </label>
    </div>
     ...
     <div class="form-submit">
      <input type="submit" id="submit" value="Registrar" class="form-input btn btn-register" />

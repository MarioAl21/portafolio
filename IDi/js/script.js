...
const expresiones = {
	...
	apellidos: /^[a-zA-ZÀ-ÿ\s]{1,16}$/, // Letras y espacios, pueden llevar acentos.
...
const validarPassword2 = () => {
	...
	if(
		...
		campos['password'] = true;
                if(inputPassword1.value.length < 8) campos['password'] = false; 
	}
}
...
formulario.addEventListener('submit', (e) => {
	...
	if(campos.nombre && campos.apellidos && campos.password 
